    ...
    return {
      ...
      data: {
        moderation: {
          ...
          scores: {
            toxicity: Math.round(analysis.moderation.scores.toxicity * 100) / 100,
            insult: Math.round(analysis.moderation.scores.insult * 100) / 100,
            threat: Math.round(analysis.moderation.scores.threat * 100) / 100,
            profanity: Math.round(analysis.moderation.scores.profanity * 100) / 100,
            identity_attack: Math.round(analysis.moderation.scores.identityAttack * 100) / 100,
          },
